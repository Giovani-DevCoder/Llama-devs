...
const Game = () => {
    // Mueve `emojis` dentro de `initializeGame`
    const initializeGame = useCallback(() => {
        ...
        setGameOver(false);
        setGameWon(false);
    }, []);  // Ahora `useCallback` no tiene dependencias adicionales
    ...
    useEffect(() => {
        initializeGame();  // Ejecuta `initializeGame` una vez cuando el componente se monta
    }, [initializeGame]);
